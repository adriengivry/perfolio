...
class Operations:
    ...
    @staticmethod
    def get_portfolio_at_date(transactions, target_date: QDate, at_close: bool):
    ...
    def get_portfolio_diff(transactions, start_date: QDate, end_date: QDate):
        ...
        start_portfolio = Operations.get_portfolio_at_date(transactions, start_date, False)
        end_portfolio = Operations.get_portfolio_at_date(transactions, end_date, True)
    ...
    def calculate_portfolio_value_at_date_from_transactions(all_transactions, symbol_cache: SymbolCache, date: QDate, at_close: bool):
        return Operations.calculate_portfolio_value_at_date(
            Operations.get_portfolio_at_date(all_transactions, date, at_close),
            symbol_cache,
            date,
            "Close"
        )
